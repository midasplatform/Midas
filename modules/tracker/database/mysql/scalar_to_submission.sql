...
BEGIN
	...
	DECLARE curs CURSOR FOR SELECT ts.submission_id, ts.producer_revision, ts.user_id, ts.official, ts.build_results_url, ts.branch, ts.extra_urls, ts.reproduction_command
