...
BEGIN
	...
	DECLARE outer_curs CURSOR FOR SELECT submission_id FROM tracker_submission;
	DECLARE curs CURSOR FOR SELECT submission_id, param_name, param_type, text_value, numeric_value FROM tracker_param, tracker_scalar WHERE tracker_param.scalar_id=tracker_scalar.scalar_id GROUP BY submission_id, param_name;
