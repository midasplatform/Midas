...
class Api_CallGroupMethodsTest extends Api_CallMethodsTestCase
{
    ...
    public function testGroupAddRemove()
    {
        ...
        $addMethodRequiredParams = array(
            ...
            array('name' => 'name', 'valid' => $newGroupName),
        ); // no invalid name
        ...
        foreach ($existingGroups as $existingGroup) {
            $this->assertNotEquals(
                ...
                'added group has the same id as an existing group'
            );
        }
    ...
    public function testGroupListUsers()
    {
        ...
        $commUsers = array(
            $commMemberId => $commMember,
            $commModeratorId => $commModerator,
            $commAdminId => $commAdmin,
        );
