...
class Thumbnailcreator_ConfigForm extends AppForm
{
    ...
    public function createConfigForm()
    {
        ...
        $form->setAction($this->webroot.'/thumbnailcreator/config/index')->setMethod('post');
    ...
    public function createThumbnailerForm()
    {
        ...
        $useThumbnailer->addMultiOptions(
            array(
                MIDAS_THUMBNAILCREATOR_NOT_USE_THUMBNAILER => $this->t(
                    "Do not have thumbnailer or do not want to use it."
                ),
                MIDAS_THUMBNAILCREATOR_USE_THUMBNAILER => $this->t(
                    "Have thumbnailer and want to use it to support more image formats."
                ),
            )
        )->setRequired(true)->setValue(MIDAS_THUMBNAILCREATOR_NOT_USE_THUMBNAILER);
