...
/** Notification manager for the dicomextractor module */
class Dicomextractor_Notification extends ApiEnabled_Notification
{
    ...
    public function getItemMenuLink($params)
    {
        ...
        return '<li id="dicomExtractListItem" style="display: none;">'.'<a id="dicomExtractAction" href="#">'.'<img alt="" src="'.$webroot.'/modules/'.$this->moduleName.'/public/images/dicom_icon.jpg" /> '.$this->t(
    ...
    {
        return array(
            $this->moduleWebroot.'/public/js/item/dicomextractor.item.view.js',
