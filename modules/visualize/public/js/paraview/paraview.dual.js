...
midas.visualize._dataOpened = function (side, retVal) {
    ...
    midas.visualize[side].cameraFocalPoint = [midas.visualize[side].midI, midas.visualize[side].midJ, midas.visualize[side].midK];
    midas.visualize[side].cameraPosition = [midas.visualize[side].midI, midas.visualize[side].midJ, midas.visualize[side].bounds[4] - 10];
