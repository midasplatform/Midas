...
function checkDB(obj) {
    ...
    $.ajax({
        ...
        data: {
            ...
            host: obj.find('[name=host]').val(),
            username: obj.find('[name=username]').val(),
            password: obj.find('[name=password]').val(),
            dbname: obj.find('[name=dbname]').val(),
            port: obj.find('[name=port]').val(),
            unix_socket: obj.find('[name=unix_socket]').val()
        },
        cache: false,
