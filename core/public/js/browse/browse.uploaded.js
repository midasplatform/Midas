...
function callbackCheckboxes(node) {
  ...
  $('a.mergeItemsLink').click(function () {
      ...
      midas.showDialogWithContent(json.item.message.merge, html, false);

      $('.mergeItemSubmit').click(function () {
          midas.browse.uploaded.mergeItems(link+'&name='+$('#mergeItemValue').val(), selectedRows);
      });
  });
}
