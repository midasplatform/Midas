...
midas.errorlog.initLogs = function () {
    ...
    if(i > 0) {
        ...
        $('table#listLogs tr.logSum td.logMessage').click(function () {
            ...
            midas.showDialogWithContent('Log', $('#fullMessage'+id).html(), true, {width: 630, height: 500});
        });
    }
}
...
midas.errorlog.successShowlog = function (responseText, statusText, xhr, form) {
    try {
        ...
        $('#currentFilterPriority').html(midas.errorlog.operationMap[resp.currentFilter.priorityOperator]
                                         +' '+midas.errorlog.priorityMap[resp.currentFilter.priority]);
    }
    catch(e) {
...
$(document).ready(function () {
    ...
    midas.errorlog.priorityMap = { 2 : 'critical', 4: 'warning', 6: 'info' };
