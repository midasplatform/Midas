...
class Core_CommunityModelTest extends DatabaseTestCase
{
    ...
    public function testCreateCommunity()
    {
        ...
        $community = $this->Community->createCommunity('test community', 'test description', 0, $user, null, '');
        ...
        $community = $this->Community->createCommunity('0', 'test description', 0, $user, null, '');
        $this->assertTrue($community != false);
    }
    ...
    public function testDeleteCommunity()
    {
        ...
        $movedFolderDeletedCommunityMemberGroupPolicy = $this->Folderpolicygroup->getPolicy(
            $deletedCommunityMemberGroup,
            $createdFolder
        );
