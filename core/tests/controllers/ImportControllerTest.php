...
class ImportControllerTest extends ControllerTestCase
  ...
  function testImportAction()
    ...
    $this->assertEquals('The form is invalid. Missing values.',
    ...
    $this->assertEquals('validate', $validateFormResponse->stage,
                        'Expected a response of successful validation.');
    ...
    $this->assertEquals('initialize', $initializeFormResponse->stage,
                        'Expected a response of successful initialization.');
    $this->assertEquals(3, $initializeFormResponse->totalfiles,
    ...
    $this->assertEquals('Import successful.', $importFormResponse->message,
                        'Actual local import failed.');
    ...
    $this->assertEquals('2', $subFoldersMap['2']->getName(),
                        'Subfolder improperly imported via local import.');
    $this->assertEquals('3', $subFoldersMap['3']->getName(),
                        'Subfolder improperly imported via local import.');
    $this->assertEquals('foo.txt', $subItems[0]->getName(),
