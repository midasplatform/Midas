...
class AppController extends MIDAS_GlobalController
  ...
  public function preDispatch()
    ...
    $browse = array(
      ...
      'downloadSelected' => $this->t('Download all selected'),
      ...
      'removeSelectedItem' => $this->t('Remove Item from Folder'),
      'deleteFolderMessage' => $this->t('Do you really want to delete the folder?'),
      'deleteItemMessage' => $this->t('Do you really want to delete this item? It cannot be undone.'),
      'removeItemMessage' => $this->t('Do you really want to remove the item?'),
  ...
  function isDynamicHelp()
    ...
    try
      ...
      if($dynamichelp && $this->userSession != null && isset($this->userSession->Dao) && $this->userSession->Dao != null  && get_class($this->userSession->Dao) != "__PHP_Incomplete_Class")
        {
