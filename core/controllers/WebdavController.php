<?php
require_once BASE_PATH.'/library/SabreDAV/lib/Sabre/autoload.php';
...
class WebDavController extends AppController
{
  ...
  function init()
   ...
   $fc = Zend_Controller_Front::getInstance();
    ...
    $rootDirectory = new Sabre_DAV_FS_Directory('C:/Julien/Test/public');
    ...
    $server->setBaseUri($webroot.'/webdav');
    ...
    $lockBackend = new Sabre_DAV_Locks_Backend_FS('C:/Julien/Test/data/');
