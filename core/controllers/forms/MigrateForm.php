...
class MigrateForm extends AppForm
{
    ...
    public function createMigrateForm($assetstores)
    {
        ...
        $midas2_hostname = new Zend_Form_Element_Text(
            'midas2_hostname',
            array('label' => $this->t('MIDAS2 Hostname'), 'size' => 60, 'value' => 'localhost')
        );
        ...
        $midas2_port = new Zend_Form_Element_Text(
            'midas2_port',
            array('label' => $this->t('MIDAS2 Port'), 'size' => 4, 'value' => '5432')
        );
        ...
        $midas2_user = new Zend_Form_Element_Text(
            'midas2_user',
            array('label' => $this->t('MIDAS2 User'), 'size' => 60, 'value' => 'midas')
        );
        ...
        $midas2_password = new Zend_Form_Element_Password(
            'midas2_password',
            array('label' => $this->t('MIDAS2 Password'), 'size' => 60, 'value' => 'midas')
        );
        ...
        $midas2_database = new Zend_Form_Element_Text(
            'midas2_database',
            array('label' => $this->t('MIDAS2 Database'), ' size' => 60, 'value' => 'midas')
        );
        ...
        $midas2_assetstore = new Zend_Form_Element_Text(
            'midas2_assetstore',
            array('label' => $this->t('MIDAS2 Assetstore Path'), 'size' => 60, 'value' => 'C:/xampp/midas/assetstore')
        );
        ...
        $midas2_assetstore_button->setDecorators(
            array(
                'ViewHelper',
