...
class ImportForm extends AppForm
{
    ...
    public function createImportForm($assetstores)
    {
        ...
        $inputDirectory = new Zend_Form_Element_Text(
            'inputdirectory',
            array('label' => $this->t('Directory on the server'), 'id' => 'inputdirectory', 'size' => 60)
        );
        ...
        $inputDirectoryButton->setDecorators(
            array(
                'ViewHelper',
        ...
        $importFolder = new Zend_Form_Element_Text(
            'importFolder',
            array('label' => $this->t('Folder Id'), 'id' => 'importFolder', 'size' => 3, 'value' => 1)
        );
