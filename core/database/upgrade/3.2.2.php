...
class Upgrade_3_2_2 extends MIDASUpgrade
{
    ...
    public function preUpgrade()
    {
        $this->existingLicenses = array(
            array(
                'constant' => LICENSE_PDDL,
                'name' => 'Public (PDDL)',
                'fulltext' => '<b>You are free:</b><ul>'.'<li>To Share: To copy, distribute and use the database.</li>'.'<li>To Create: To produce works from the database.</li>'.'<li>To Adapt: To modify, transform, and build upon the database.</li></ul>'.'<a href="http://opendatacommons.org/licenses/pddl/summary">Full License Information</a>',
            ),
            array(
                'constant' => LICENSE_ODC_BY,
                'name' => 'Public: Attribution (ODC-BY)',
                'fulltext' => '<b>You are free:</b><ul>'.'<li>To Share: To copy, distribute and use the database.</li>'.'<li>To Create: To produce works from the database.</li>'.'<li>To Adapt: To modify, transform, and build upon the database.</li></ul>'.'<b>As long as you:</b><ul>'.'<li>Attribute: You must attribute any public use of the database, or works produced from the database, '.'in the manner specified in the license. For any use or redistribution of the database, or works produced '.'from it, you must make clear to others the license of the database and keep intact any notices on the '.'original database.</li></ul>'.'<a href="http://opendatacommons.org/licenses/by/summary">Full License Information</a>',
            ),
            array(
                'constant' => LICENSE_ODBL,
    ...
    public function mysql()
    {
      ...
      PRIMARY KEY (`license_id`)
        ...
        foreach ($this->existingLicenses as $value) {
            ...
            $this->db->update('itemrevision', array('license_id' => $id), array('license = ?' => $value['constant']));
        }
